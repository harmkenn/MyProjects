---
title: "Madness Model Ken Pom Predict 2021"
author: "Ken Harmon"
...
teamcomb[, 31:ncol(teamcomb)] <- lapply(31:ncol(teamcomb), function(x) as.numeric(teamcomb[[x]]))

#Where are the NAs
teamcomb[is.na(teamcomb)] <- 0
...
#Get the difference of the just stats
The64FS <- The64F %>% select(7,10,11,18,20:45)
The64US <- The64U %>% select(7,10,11,18,20:45)
...
#Get the difference of the just stats
The32FS <- The32F %>% select(7,10,11,18,20:45)
The32US <- The32U %>% select(7,10,11,18,20:45)
...
#Get the difference of the just stats
The16FS <- The16F %>% select(7,10,11,18,20:45)
The16US <- The16U %>% select(7,10,11,18,20:45)
...
#Get the difference of the just stats
The8FS <- The8F %>% select(7,10,11,18,20:45)
The8US <- The8U %>% select(7,10,11,18,20:45)
...
#Get the difference of the just stats
The4FS <- The4F %>% select(7,10,11,18,20:45)
The4US <- The4U %>% select(7,10,11,18,20:45)
...
#Get the difference of the just stats
The2FS <- The2F %>% select(7,10,11,18,20:45)
The2US <- The2U %>% select(7,10,11,18,20:45)
