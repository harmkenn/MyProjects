...
AG1020stacked <- read.csv("AG1020stacked.csv")
teamstats <- read.csv("SRstats1020.csv")
teamcomb <- left_join(AG1020stacked,teamstats,by=c("Year"="Year","Team"="School"))
...
AG1018F <- teamcomb %>% filter(Favored == "F" & Year != pyear & Year != 2020)
AG1018U <- teamcomb %>% filter(Favored == "U" & Year != pyear & Year != 2020)

#Get the difference of the just stats
AG1018FS <- AG1018F %>% select(7,10,16:63)
AG1018US <- AG1018U %>% select(7,10,16:63)
dStats1018 <- AG1018FS - AG1018US

# Set seed and create assignment

assignment <- sample(1:2, size = nrow(dStats1018), prob = c(.8,.2), replace = TRUE)

# Create a train, validation and tests from the original data frame 
NCAA_train <- dStats1018[assignment == 1, ]    # subset NCAA to training indices only
NCAA_test <- dStats1018[assignment == 2, ]   # subset NCAA to test indices only
...
The64 <- teamcomb %>% filter(Year == pyear & Round == 1) %>% select(1,3:8,10,16:63)
...
#Get the difference of the just stats
The64FS <- The64F %>% select(6,9:56)
The64US <- The64U %>% select(6,9:56)
...
# Need to assign F and U to Predictions from round 1
The32 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred1) %>% select(1,3:8,10,16:63)
...
#Get the difference of the just stats
The32FS <- The32F %>% select(6,9:56)
The32US <- The32U %>% select(6,9:56)
...
The16 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred2) %>% select(1,3:8,10,16:63)
...
#Get the difference of the just stats
The16FS <- The16F %>% select(6,9:56)
The16US <- The16U %>% select(6,9:56)
...
The8 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred3) %>% select(1,3:8,10,16:63)
...
#Get the difference of the just stats
The8FS <- The8F %>% select(6,9:56)
The8US <- The8U %>% select(6,9:56)
...
The4 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred4) %>% select(1,3:8,10,16:63)
...
#Get the difference of the just stats
The4FS <- The4F %>% select(6,9:56)
The4US <- The4U %>% select(6,9:56)
...
The2 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred5) %>% select(1,3:8,10,16:63)
...
#Get the difference of the just stats
The2FS <- The2F %>% select(6,9:56)
The2US <- The2U %>% select(6,9:56)
