...
AG0318FS <- AG0318F %>% select(7,10,16:59)
AG0318US <- AG0318U %>% select(7,10,16:59)
...
The64 <- teamcomb %>% filter(Year == pyear & Round == 1) %>% select(1,3:8,10,16:59)
...
#Get the difference of the just stats
The64FS <- The64F %>% select(6,9:52)
The64US <- The64U %>% select(6,9:52)
...
# Need to assign F and U to Predictions from round 1
The32 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred1) %>% select(1,3:8,10,16:59)
...
#Get the difference of the just stats
The32FS <- The32F %>% select(6,9:52)
The32US <- The32U %>% select(6,9:52)
...
The16 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred2) %>% select(1,3:8,10,16:59)
...
#Get the difference of the just stats
The16FS <- The16F %>% select(6,9:52)
The16US <- The16U %>% select(6,9:52)
...
The8 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred3) %>% select(1,3:8,10,16:59)
...
#Get the difference of the just stats
The8FS <- The8F %>% select(6,9:52)
The8US <- The8U %>% select(6,9:52)
...
The4 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred4) %>% select(1,3:8,10,16:59)
...
#Get the difference of the just stats
The4FS <- The4F %>% select(6,9:52)
The4US <- The4U %>% select(6,9:52)
...
The2 <- teamcomb %>% filter(Year == pyear & Round == 1 & Team %in% pred5) %>% select(1,3:8,10,16:59)
...
#Get the difference of the just stats
The2FS <- The2F %>% select(6,9:52)
The2US <- The2U %>% select(6,9:52)
