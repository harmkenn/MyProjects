...
AG0219FS <- AG0219F %>% select(7,10,20:24,26,30)
AG0219US <- AG0219U %>% select(7,10,20:24,26,30)
...
#Get the difference of the just stats
The64FS <- The64F %>% select(7,10,20:24,26,30)
The64US <- The64U %>% select(7,10,20:24,26,30)
...
#Get the difference of the just stats
The32FS <- The32F %>% select(7,10,20:24,26,30)
The32US <- The32U %>% select(7,10,20:24,26,30)
...
#Get the difference of the just stats
The16FS <- The16F %>% select(7,10,20:24,26,30)
The16US <- The16U %>% select(7,10,20:24,26,30)
...
#Get the difference of the just stats
The8FS <- The8F %>% select(7,10,20:24,26,30)
The8US <- The8U %>% select(7,10,20:24,26,30)
...
#Get the difference of the just stats
The4FS <- The4F %>% select(7,10,20:24,26,30)
The4US <- The4U %>% select(7,10,20:24,26,30)
...
#Get the difference of the just stats
The2FS <- The2F %>% select(7,10,20:24,26,30)
The2US <- The2U %>% select(7,10,20:24,26,30)
