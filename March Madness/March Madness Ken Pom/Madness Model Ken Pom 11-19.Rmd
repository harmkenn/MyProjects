---
title: "Madness Model Ken Pom 11-19"
author: "Ken Harmon"
...
AG0219FS <- AG0219F %>% select(7,10,11,15,16,18:28)
AG0219US <- AG0219U %>% select(7,10,11,15,16,18:28)
dStats0219 <- AG0219FS - AG0219US

# Set seed and create assignment

assignment <- sample(1:2, size = nrow(dStats0219), prob = c(.8,.2), replace = TRUE)
...
#Get the difference of the just stats
The64FS <- The64F %>% select(7,10,11,15,16,18:28)
The64US <- The64U %>% select(7,10,11,15,16,18:28)
...
#Get the difference of the just stats
The32FS <- The32F %>% select(7,10,11,15,16,18:28)
The32US <- The32U %>% select(7,10,11,15,16,18:28)
...
#Get the difference of the just stats
The16FS <- The16F %>% select(7,10,11,15,16,18:28)
The16US <- The16U %>% select(7,10,11,15,16,18:28)
...
#Get the difference of the just stats
The8FS <- The8F %>% select(7,10,11,15,16,18:28)
The8US <- The8U %>% select(7,10,11,15,16,18:28)
...
#Get the difference of the just stats
The4FS <- The4F %>% select(7,10,11,15,16,18:28)
The4US <- The4U %>% select(7,10,11,15,16,18:28)
...
#Get the difference of the just stats
The2FS <- The2F %>% select(7,10,11,15,16,18:28)
The2US <- The2U %>% select(7,10,11,15,16,18:28)
