...
AG0221stacked <- read.csv("AG0221stacked.csv")
teamstats <- read.csv("KenPom02-21.csv")
teamcomb <- left_join(AG0221stacked,teamstats,by=c("Year"="Year","Team"="Team"))
...
AG0219FS <- AG0219F %>% select(7,10,15,18,20:28)
AG0219US <- AG0219U %>% select(7,10,15,18,20:28)
...
#Get the difference of the just stats
The64FS <- The64F %>% select(7,10,15,18,20:28)
The64US <- The64U %>% select(7,10,15,18,20:28)
...
#Get the difference of the just stats
The32FS <- The32F %>% select(7,10,15,18,20:28)
The32US <- The32U %>% select(7,10,15,18,20:28)
...
#Get the difference of the just stats
The16FS <- The16F %>% select(7,10,15,18,20:28)
The16US <- The16U %>% select(7,10,15,18,20:28)
...
#Get the difference of the just stats
The8FS <- The8F %>% select(7,10,15,18,20:28)
The8US <- The8U %>% select(7,10,15,18,20:28)
...
#Get the difference of the just stats
The4FS <- The4F %>% select(7,10,15,18,20:28)
The4US <- The4U %>% select(7,10,15,18,20:28)
...
#Get the difference of the just stats
The2FS <- The2F %>% select(7,10,15,18,20:28)
The2US <- The2U %>% select(7,10,15,18,20:28)
