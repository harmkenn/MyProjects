...
<<<<<<< HEAD:StatisticsClass/Graphics.Rmd
ggplot(pon, aes(x = Age, fill = factor(Political.Affiliation))) + geom_dotplot(binwidth = 1)
=======
ggplot(dp, aes(x = Meta, fill = factor(Cert))) + geom_dotplot(binwidth = .8)
>>>>>>> dfdbe6955c2877864c56f00cea9704ab20b6c1af:StatisticsClass/IMDB/IMDB_Graphics.Rmd
```
